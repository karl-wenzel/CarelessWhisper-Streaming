...
def _save_untrained_checkpoint(model: LoRAStreamedWhisper, check_output_dir: str, cfg: Config) -> Path:
    ...
    checkpoint = {
        ...
        "hyper_parameters": {
            ...
            "rank": cfg.rank,
            "encoder_rank": cfg.encoder_rank if cfg.encoder_rank is not None else cfg.rank,
            "decoder_rank": cfg.decoder_rank if cfg.decoder_rank is not None else cfg.rank,
            "multilingual": cfg.multilingual,
            "encoder_positional_mode": cfg.encoder_positional_mode,
        },
        "cfg": vars(cfg),
...
if __name__ == "__main__":
    ...
    cfg = Config(
        ...
        rank=args.rank,
        encoder_rank=args.encoder_rank,
